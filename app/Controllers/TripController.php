...
class TripController
{
    ...
    public function store()
    {
        ...
        $stmt = $pdo->prepare(" INSERT INTO trips (departure_agency_id, arrival_agency_id, departure_datetime, arrival_datetime, available_seats, driver_id) VALUES (?, ?, ?, ?, ?, ?) ");
        $stmt->execute([$_POST['departure_agency_id'], $_POST['arrival_agency_id'], $_POST['departure_datetime'], $_POST['arrival_datetime'], $_POST['available_seats'], $userId]);
    ...
    public function reserve()
    {
        ...
        $stmt = $pdo->prepare(" SELECT * FROM reservations WHERE user_id = ? AND trip_id = ? ");
        ...
        $stmt = $pdo->prepare(" INSERT INTO reservations (user_id, trip_id) VALUES (?, ?) ");
        $stmt->execute([$userId, $tripId]);
